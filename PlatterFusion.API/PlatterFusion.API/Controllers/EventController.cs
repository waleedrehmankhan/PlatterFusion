...
namespace PlatterFusion.API.Controllers
{
    ...
    public class EventController : ControllerBase
    {
        ...
        [HttpPost("All")]
        public async Task<ContentResult> GetEvent(GetEventInput input)
        {
            try
            {
        ...
        [HttpPost("GetById")]
        public async Task<ContentResult> GetEventById(GetEventInput input)
        {
        ...
        [ValidateFilter]
        public async Task<ContentResult> CreateOrUpdateEvent(EventDto eventDto)
        {
            ReturnMessage rm = new ReturnMessage(1, "Success");
        ...
        [HttpPost("Delete")]
        public async Task<ContentResult> DeleteEvent(GetEventInput input)
        {
            ReturnMessage rm = new ReturnMessage(1, "Success");
